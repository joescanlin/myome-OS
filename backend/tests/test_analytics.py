...
from myome.analytics.correlation.engine import CorrelationResult
...
class TestAlertManager:
    ...
    def test_get_active_alerts(self):
        ...
        for i in range(3):
            anomaly = Anomaly(
                timestamp=datetime.now(UTC) + timedelta(hours=i + 1),  # Different times
...
class TestGlucoseResponsePredictor:
    ...
    def test_extract_features(self):
        ...
        context = MealContext(
            ...
            fat_g=20.0,
            glycemic_load=30.0,
            time_of_day=datetime(2026, 1, 15, 12, 30, tzinfo=UTC),
