...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('api_credentials', postgresql.JSONB(), nullable=False, server_default='{}'),
        sa.Column('calibration_params', postgresql.JSONB(), nullable=False, server_default='{}'),
        sa.Column('device_metadata', postgresql.JSONB(), nullable=False, server_default='{}'),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    ...
    op.create_index('ix_device_readings_reading_type', 'device_readings', ['reading_type'])
    ...
    op.create_table(
        ...
        sa.Column('adjusted_ranges', postgresql.JSONB(), nullable=False, server_default='{}'),
    ...
    op.create_index('ix_biomarker_definitions_category', 'biomarker_definitions', ['category'])
    ...
    op.create_index('ix_biomarker_readings_biomarker_id', 'biomarker_readings', ['biomarker_id'])
    op.create_index('ix_biomarker_readings_timestamp', 'biomarker_readings', ['timestamp'])
    ...
    op.create_table(
        ...
        sa.Column('associated_conditions', postgresql.ARRAY(sa.String()), nullable=False, server_default='{}'),
    ...
    op.create_index('ix_glucose_user_time', 'glucose_readings', ['user_id', 'timestamp'])
    ...
    op.create_index('ix_activity_user_time', 'activity_readings', ['user_id', 'timestamp'])
    ...
    op.create_index('ix_body_comp_user_time', 'body_composition', ['user_id', 'timestamp'])
