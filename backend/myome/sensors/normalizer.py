...
class DataNormalizer:
    ...
    def normalize(self, measurement: Measurement) -> Optional[Measurement]:
        """
        ...
        if converter is None:
            ...
            return Measurement(
                ...
                metadata={**measurement.metadata, "normalization_error": "unknown_unit"},
            )
            ...
            if gap > expected_interval and gap <= max_gap:
                ...
                for j in range(1, num_points + 1):
                    ...
                    result.append(Measurement(
                        ...
                        quality=DataQuality.LOW,
                        metadata={"imputed": True, "method": "linear_interpolation"},
                    ))
