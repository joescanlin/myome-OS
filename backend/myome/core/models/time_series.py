...
class HeartRateReading(Base):
    ...
    __table_args__ = (
        Index("ix_hr_user_time", "user_id", "timestamp"),
    )
...
class HRVReading(Base):
    ...
    # Time-domain metrics
    sdnn_ms: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    rmssd_ms: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    pnn50_pct: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    
    # Frequency-domain metrics
    lf_power: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    hf_power: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    lf_hf_ratio: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    
    # Context
    device_id: Mapped[Optional[str]] = mapped_column(UUID(as_uuid=False), nullable=True)
    measurement_duration_sec: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    
    __table_args__ = (
        Index("ix_hrv_user_time", "user_id", "timestamp"),
    )
...
class GlucoseReading(Base):
    ...
    calibration_factor: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    
    # Context
    device_id: Mapped[Optional[str]] = mapped_column(UUID(as_uuid=False), nullable=True)
    meal_context: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    
    __table_args__ = (
        Index("ix_glucose_user_time", "user_id", "timestamp"),
    )
...
class SleepSession(Base):
    ...
    sleep_onset_latency_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    wake_after_sleep_onset_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    # Quality metrics
    sleep_efficiency_pct: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    sleep_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    
    # Physiological metrics during sleep
    avg_heart_rate_bpm: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    min_heart_rate_bpm: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    avg_spo2_pct: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
...
class SleepEpoch(Base):
    ...
    movement_intensity: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    
    __table_args__ = (
        Index("ix_epoch_session", "session_id", "timestamp"),
    )
...
class ActivityReading(Base):
    ...
    # Activity intensity
    activity_type: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    intensity_level: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    
    # Heart rate zones (minutes)
    hr_zone_1_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    hr_zone_2_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    hr_zone_3_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    hr_zone_4_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    hr_zone_5_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
...
class BodyComposition(Base):
    ...
    __table_args__ = (
        Index("ix_body_comp_user_time", "user_id", "timestamp"),
    )
