...
class GenomicVariant(Base, UUIDMixin, TimestampMixin):
    ...
    rsid: Mapped[str | None] = mapped_column(String(20), index=True, nullable=True)
    ...
    # Gene association
    gene: Mapped[str | None] = mapped_column(String(50), nullable=True)
...
class PolygeniScore(Base, UUIDMixin, TimestampMixin):
    ...
    relative_risk: Mapped[float | None] = mapped_column(Float, nullable=True)

    # Score details
    num_variants: Mapped[int | None] = mapped_column(Integer, nullable=True)
    model_version: Mapped[str | None] = mapped_column(String(50), nullable=True)

    # Population reference
    reference_population: Mapped[str | None] = mapped_column(String(50), nullable=True)
