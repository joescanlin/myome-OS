...
class LabPanel(Base, UUIDMixin, TimestampMixin):
    ...
    panel_code: Mapped[str | None] = mapped_column(String(50), nullable=True)
    ...
    fasting: Mapped[bool | None] = mapped_column(nullable=True)

    # Lab info
    lab_name: Mapped[str | None] = mapped_column(String(200), nullable=True)
    lab_accession_number: Mapped[str | None] = mapped_column(String(100), nullable=True)
    ordering_provider: Mapped[str | None] = mapped_column(String(200), nullable=True)
