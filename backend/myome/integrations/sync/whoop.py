...
class WhoopSyncService:
    ...
    async def ensure_valid_token(self) -> OAuthTokens:
        ...
        if self.tokens.is_expired():
            ...
            try:
                ...
                if self._client:
                    self._client.headers["Authorization"] = f"Bearer {self.tokens.access_token}"
            finally:
                await oauth.close()
        return self.tokens
    ...
    async def sync_all_data(
        ...
        from myome.core.models import (
            HeartRateReading, HRVReading, SleepSession,
        )
        ...
        async with async_session_factory() as session:
            ...
            try:
                ...
                for record in sleep_records:
                    ...
                    sleep = SleepSession(
                        ...
                        total_sleep_minutes=int(stage.get("total_in_bed_time_milli", 0) / 60000),
                        time_in_bed_minutes=int(stage.get("total_in_bed_time_milli", 0) / 60000),
            ...
            try:
                recovery_records = await self.get_recovery_collection(start, end, limit=100)
            ...
            # Sync workout data
            try:
                workout_records = await self.get_workout_collection(start, end, limit=100)
