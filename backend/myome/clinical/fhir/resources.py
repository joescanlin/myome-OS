...
class FHIRResourceGenerator:
    ...
    def create_glucose_observation(
        self, glucose_mg_dl: float, timestamp: datetime
    ) -> dict:
    ...
    def create_body_weight_observation(
        self, weight_kg: float, timestamp: datetime
    ) -> dict:
    ...
    def _map_gender(self, biological_sex: str | None) -> str:
